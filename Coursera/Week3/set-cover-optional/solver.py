...
from ortools_solver import mip
from lns_mip import localsearch
...
def solve_it(input_data):
    ...
    #ortools
    # obj, is_optimal, solution = mip(set_count, item_count, sets, max_minutes=10)
    
	#greedy
    # is_optimal, solution = greedy(set_count, item_count, sets)
    
    # lns with mip
    is_optimal, solution = localsearch(set_count, item_count, sets)
